...
public:
	...
	UPROPERTY(VisibleAnywhere, BlueprintReadWrite) FDamageEffectParams ExplosionDamageParams;

	UFUNCTION(BlueprintImplementableEvent) void StartOutgoingTimeline();
