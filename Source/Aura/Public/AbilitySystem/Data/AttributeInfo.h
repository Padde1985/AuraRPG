...
struct FAuraAttributeInfo
{
	...
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly) FGameplayTag AttributeTag;
...
public:
	UPROPERTY(EditDefaultsOnly, BlueprintReadOnly) TMap<FGameplayTag, FAuraAttributeInfo> AttributeInformation;
